...
import ai.smarthub.infer.synthetic.synthetic_data_generator.config.WebClientConfig;
...
public class DeviceService {
    ...
    public String createDevice(DeviceCreateEvent deviceRequest) {
        // register device
    ...
    private String registerDevice(DeviceCreateEvent deviceRequest) {
